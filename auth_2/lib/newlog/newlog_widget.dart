...
import 'newlog_model.dart';
export 'newlog_model.dart';

class NewlogWidget extends StatefulWidget {
  const NewlogWidget({super.key});

  static String routeName = 'newlog';
  static String routePath = '/newlog';
                      ...
                      children: [
                        ...
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              0.0, 12.0, 0.0, 12.0),
                          child: Text(
                            'Log Your Victories-Tap Your Method',
